...
import shop.order.domain.Address;
...
public class OrderCustomerAdapter {
	...
	public static CustomerDTO getCustomerDTO (OrderCustomerDTO customerDTO) {
	...
	public static OrderCustomerDTO getOrderCustomerDTO (CustomerDTO customer) {
